    ...
    <section className="flex flex-col">
      <header className="mb-3 flex items-baseline justify-between gap-2">
        <div className="flex items-baseline gap-2">
          ...
          <span className="num text-[10px] uppercase copper">
            ...
            >
              ...
              <div className="flex flex-wrap items-center gap-2 pl-5">
                  ...
                  {PRIORITIES.map((priority) => {
                    ...
                    return (
                      <button
                        ...
                        aria-pressed={active}
                        className={`num rounded-sm px-1.5 py-0.5 text-[10px] uppercase transition-colors ${
                ...
                <button
                  ...
                  disabled={isSaving}
                  className="num ml-auto flex h-6 items-center gap-1 rounded-sm bg-copper px-2 text-[10px] uppercase text-primary-foreground hover:opacity-90 disabled:opacity-50"
                >
                  {isSaving ? (
